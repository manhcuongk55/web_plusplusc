...
class Agama_Partial_Refresh {
    ...
    function preview_slide_2_button() {
        return esc_html( get_theme_mod( 'agama_slider_button_title_2', __( 'Chi tiết', 'agama' ) ) );
    }
    ...
    function preview_fbox_1_title() {
        $title = esc_html( get_theme_mod( 'agama_frontpage_box_1_title', __( 'Lập trình ứng dụng', 'agama' ) ) );
        return $title;
    }
