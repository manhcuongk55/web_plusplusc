...
class Agama_Slider {
	...
	private static function get_options() {
		...
		$slide['1']['title']		= esc_attr( get_theme_mod( 'agama_slider_title_1', 'Chào mừng bạn đến với khóa học lập trình của chúng tôi!' ) );
		$slide['2']['title']		= esc_attr( get_theme_mod( 'agama_slider_title_2', 'Chào mừng bạn đến với khóa học lập trình của chúng tôi!' ) );
		...
		$button['1']['title'] 		= esc_attr( get_theme_mod( 'agama_slider_button_title_1', 'TÌM HIỂU THÊM' ) );
		$button['2']['title'] 		= esc_attr( get_theme_mod( 'agama_slider_button_title_2', 'TÌM HIỂU THÊM' ) );
