...
class Agama_Front_Page_Boxes {
	...
	private static function get_options() {
		...
		if( $boxes['enabled'] ) {
			...
			$box[1]['title'] 		= esc_html( get_theme_mod( 'agama_frontpage_box_1_title', 'LẬP TRÌNH ỨNG DỤNG' ) );
			$box[2]['title'] 		= esc_html( get_theme_mod( 'agama_frontpage_box_2_title', 'THIẾT KẾ VÀ LẬP TRÌNH WEBSITE PHP' ) );
			$box[3]['title'] 		= esc_html( get_theme_mod( 'agama_frontpage_box_3_title', 'KHÓA HỌC THIẾT KẾ ĐA PHƯƠNG TIỆN' ) );
			$box[4]['title'] 		= esc_html( get_theme_mod( 'agama_frontpage_box_4_title', 'LẬP TRÌNH NHÚNG' ) );
